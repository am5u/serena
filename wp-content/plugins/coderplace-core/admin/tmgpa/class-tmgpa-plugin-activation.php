	...
	class TGM_Plugin_Activation {
		...
		public function init() {
			...
			if ( $this->is_tgmpa_page() ) {
				wp_enqueue_style( 'tgmpa-css', CPCORE_URL . 'admin/tmgpa/assets/tgmpa.css', false, '1.0.0' );
			}
		...
		protected function _gather_plugin_data() {
			...
			foreach ( $plugins[ $this->view_context ] as $slug => $plugin ) {
				...
				if ( isset( $plugin['image'] ) ) :
					//$table_data[ $i ]['plugin'] .= '<div class="tgmpa-plugin-image"><img src="' . CPCORE_URL . 'admin/tmgpa/assets/plugins/' . esc_attr( $plugin['image'] ) . '" /></div>';
					$table_data[ $i ]['plugin'] .= '<div class="tgmpa-plugin-image"><img src="' . esc_url( $plugin['image'] ) . '" /></div>';
				endif;
				/* Custom Changes - Ends */
