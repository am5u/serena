 ...
 * @subpackage Example
 * @version    2.6.2 for plugin CoderPlace Core
 ...
 */
require_once dirname( __FILE__ ) . '/class-tmgpa-plugin-activation.php';
...
function tmc_register_required_plugins() {
	 ...
	 */
	$config = array(
		'id'           => 'coderplace-core',     // Unique ID for hashing notices for multiple instances of TGMPA.
		...
		<div class="install-plugin-message">
			<h1>Install the required and recommended plugins for the <strong>CoderPlace Theme</strong>.</h1>
