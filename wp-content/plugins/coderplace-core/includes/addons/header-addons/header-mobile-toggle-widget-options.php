...
$settings = array(
	'header_mobile_toggle_widget_tabs' => array(
		'control_type' => 'base_tab_control',
		'section'      => 'header_mobile_toggle_widget',
		'settings'     => false,
		'priority'     => 1,
		'input_attrs'  => array(
			'general' => array(
				'label'  => __( 'General', 'coderplace-core' ),
				'target' => 'header_mobile_toggle_widget',
			),
			'design' => array(
				'label'  => __( 'Design', 'coderplace-core' ),
				'target' => 'header_mobile_toggle_widget_design',
			),
			'active' => 'general',
		),
	),
	'header_mobile_toggle_widget_tabs_design' => array(
		'control_type' => 'base_tab_control',
		'section'      => 'header_mobile_toggle_widget_design',
		'settings'     => false,
		'priority'     => 1,
		'input_attrs'  => array(
			'general' => array(
	...
	'header_mobile_toggle_widget_label' => array(
		'control_type' => 'base_text_control',
		'sanitize'     => 'sanitize_text_field',
		'section'      => 'header_mobile_toggle_widget',
		'default'      => webapp()->default( 'header_mobile_toggle_widget_label' ),
	...
	'header_mobile_toggle_widget_icon' => array(
		'control_type' => 'base_radio_icon_control',
		'section'      => 'header_mobile_toggle_widget',
		'default'      => webapp()->default( 'header_mobile_toggle_widget_icon' ),
	...
	'header_mobile_toggle_widget_style' => array(
		'control_type' => 'base_radio_icon_control',
		'section'      => 'header_mobile_toggle_widget_design',
		'default'      => webapp()->default( 'header_mobile_toggle_widget_style' ),
	...
	'header_mobile_toggle_widget_border' => array(
		...
		'default'      => webapp()->default( 'header_mobile_toggle_widget_border' ),
		'context'      => array(
			array(
				'setting'    => 'header_mobile_toggle_widget_style',
	...
	'header_mobile_toggle_widget_icon_size' => array(
		...
		'default'      => webapp()->default( 'header_mobile_toggle_widget_icon_size' ),
		'input_attrs'  => array(
			'min'        => array(
				'px'  => 0,
				'em'  => 0,
	...
	'header_mobile_toggle_widget_color' => array(
		...
		'default'      => webapp()->default( 'header_mobile_toggle_widget_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'header_mobile_toggle_widget_background' => array(
		...
		'default'      => webapp()->default( 'header_mobile_toggle_widget_background' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.widget-toggle-open-container .widget-toggle-open',
	...
	'header_mobile_toggle_widget_typography' => array(
		...
		'context'      => array(
			array(
				'setting'  => 'header_mobile_toggle_widget_label',
				'operator' => '!empty',
				'value'    => '',
			),
		),
		'default'      => webapp()->default( 'header_mobile_toggle_widget_typography' ),
		'live_method'     => array(
			array(
				'type'     => 'css_typography',
				'selector' => '.widget-toggle-open-container .widget-toggle-open',
		...
		'input_attrs'  => array(
			'id'      => 'header_mobile_toggle_widget_typography',
			'options' => 'no-color',
		),
	),
	'header_mobile_toggle_widget_padding' => array(
		...
		'section'      => 'header_mobile_toggle_widget_design',
		'default'      => webapp()->default( 'header_mobile_toggle_widget_padding' ),
...
$widget_settings = array(
	...
	'info_header_mobile_toggle_widget_design' => array(
		'control_type' => 'base_title_control',
		'section'      => 'sidebar-widgets-header2',
	...
	'header_mobile_toggle_widget_layout' => array(
		'control_type' => 'base_radio_icon_control',
		'section'      => 'sidebar-widgets-header2',
		'default'      => webapp()->default( 'header_mobile_toggle_widget_layout' ),
	...
	'header_mobile_toggle_widget_side' => array(
		'control_type' => 'base_radio_icon_control',
		'section'      => 'sidebar-widgets-header2',
		'default'      => webapp()->default( 'header_mobile_toggle_widget_side' ),
		...
		'context'      => array(
			...
			array(
				'setting'    => 'header_mobile_toggle_widget_layout',
				'operator'   => 'sub_object_contains',
				'sub_key'    => 'layout',
				'responsive' => false,
				'value'      => 'sidepanel',
	...
	'header_mobile_toggle_widget_pop_width' => array(
		...
		'default'      => webapp()->default( 'header_mobile_toggle_widget_pop_width' ),
		'input_attrs'  => array(
			'min'        => array(
				'px' => 100,
				'%'  => 10,
	...
	'header_mobile_toggle_widget_pop_background' => array(
		...
		'default'      => webapp()->default( 'header_mobile_toggle_widget_pop_background' ),
		'live_method'     => array(
			array(
				'type'     => 'css_background',
	...
	'header_mobile_toggle_widget_close_color' => array(
		...
		'default'      => webapp()->default( 'header_mobile_toggle_widget_close_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
